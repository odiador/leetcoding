...
console.log('MERCADO_PAGO_ACCESS_TOKEN exists:', !!env.MERCADO_PAGO_ACCESS_TOKEN)
console.log('MERCADO_PAGO_TEST_ACCESS_TOKEN exists:', !!env.MERCADO_PAGO_TEST_ACCESS_TOKEN)
console.log('MERCADO_PAGO_PUBLIC_KEY exists:', !!env.MERCADO_PAGO_PUBLIC_KEY)
console.log('MERCADO_PAGO_WEBHOOK_PATH:', env.MERCADO_PAGO_WEBHOOK_PATH)
